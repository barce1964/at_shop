	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href='/news/n/<?php echo $newsItem[0] ;?>'><?php echo $newsItem[1].' # '.$newsItem[0];?></a></h2>
						<p class="meta">Posted by <a href="#"><?php echo $newsItem[5];?></a> on <?php echo $newsItem[2];?>
							&nbsp;&bull;&nbsp; <a href='/news/' class="permalink">Вернутся к списку новостей</a></p>
						<div class="entry">
							<p><img src="../../images/pic01.jpg" width="800" height="300" alt="" /></p>
							<p><?php echo $newsItem[4];?></p>
						</div>
					</div>
					<p><a href='/news/' class="permalink">Вернутся к списку новостей</a></p>
